...
| Title     | Tools File Archiver 7z                               |
| --------- | ---------------------------------------------------- |
| Created @ | `2024-03-12T15:42:16Z`                               |
| Updated @ | `2024-03-12T15:42:17Z`                               |
| Labels    | \`\`                                                 |
| Edit @    | [here](https://github.com/junxnone/linux/issues/128) |
...
3、将压缩文件 text.7z 中的 `dir1/dir2` 和 `dir1/file1`
提取到在指定目录(/home/text)下（保持原有路径结构）。
